// MySQL adapter as a drop-in replacement for Prisma
import pool from './db.js';

// This object mimics the basic Prisma client with MySQL implementation
const prisma = {
  ...
  // Mock Prisma's transaction method
  ...
  user: {
    findUnique: async ({ where, include }) => {
      ...
      // Get the basic user
      if (where.id) {
        const users = await prisma.query('SELECT * FROM users WHERE id = ? LIMIT 1', [where.id]);
        user = users[0] || null;
      } else if (where.email) {
        const users = await prisma.query('SELECT * FROM users WHERE email = ? LIMIT 1', [where.email]);
        user = users[0] || null;
      }
      ...
      if (include) {
        ...
        if (include.superAdmin) {
          const superAdmins = await prisma.query(
        ...
        if (include.customer) {
          const customers = await prisma.query(
        ...
        if (include.staff) {
          const staffMembers = await prisma.query(
    ...
    findFirst: async ({ where, orderBy, select, include }) => {
      ...
      const users = await prisma.query(sql, params);
    ...
    create: async ({ data }) => {
      ...
      const result = await prisma.query(sql, values);
    ...
    update: async ({ where, data }) => {
      ...
      await prisma.query(sql, [...values, ...whereValues]);
    ...
    delete: async ({ where }) => {
      ...
      await prisma.query(sql, whereValues);
      return { id: where.id };
    },
    ...
    count: async ({ where }) => {
      ...
      const result = await prisma.query(sql, params);
  ...
  hotel: {
    findUnique: async ({ where, include }) => {
      ...
      if (where.id) {
        const hotels = await prisma.query('SELECT * FROM hotels WHERE id = ? LIMIT 1', [where.id]);
        hotel = hotels[0] || null;
      }
      ...
      if (include) {
        if (include.vendor) {
          const vendors = await prisma.query('SELECT * FROM vendors WHERE id = ? LIMIT 1', [hotel.vendorId]);
          hotel.vendor = vendors[0] || null;
        }
        
        if (include.rooms) {
          const rooms = await prisma.query('SELECT * FROM rooms WHERE hotelId = ?', [hotel.id]);
          hotel.rooms = rooms;
        }
        
        if (include.amenities) {
          const amenities = await prisma.query(`
    ...
    findMany: async ({ where, orderBy, take, skip, include }) => {
      ...
      const hotels = await prisma.query(sql, params);
      ...
      if (include && hotels.length > 0) {
        ...
        if (include.vendor) {
          ...
          const vendors = await prisma.query('SELECT * FROM vendors WHERE id IN (?)', [vendorIds]);
        ...
        if (include.rooms) {
          const rooms = await prisma.query('SELECT * FROM rooms WHERE hotelId IN (?)', [hotelIds]);
        ...
        if (include.amenities) {
          ...
          const amenities = await prisma.query(amenityQuery, [hotelIds]);
    ...
    create: async ({ data }) => {
      ...
      if (amenities && amenities.length > 0) {
        ...
        await prisma.query(amenitySql, [amenityValues]);
      }
    ...
    update: async ({ where, data }) => {
      ...
      if (Object.keys(hotelData).length > 0) {
        ...
        await prisma.query(sql, [...values, where.id]);
      }
      
      // Handle amenities if provided
      if (amenities) {
        // Delete existing amenities
        await prisma.query('DELETE FROM hotel_amenities WHERE hotelId = ?', [where.id]);
      ...
      return prisma.hotel.findUnique({ where });
    },
    
    delete: async ({ where }) => {
      // Delete related records first (cascade delete)
      await prisma.query('DELETE FROM hotel_amenities WHERE hotelId = ?', [where.id]);
      await prisma.query('DELETE FROM rooms WHERE hotelId = ?', [where.id]);
      
      // Delete the hotel
      await prisma.query('DELETE FROM hotels WHERE id = ?', [where.id]);
  ...
  booking: {
    findUnique: async ({ where, include }) => {
      ...
      if (where.id) {
        const bookings = await prisma.query('SELECT * FROM bookings WHERE id = ? LIMIT 1', [where.id]);
      ...
      if (include) {
        if (include.customer) {
          const customers = await prisma.query('SELECT * FROM customers WHERE id = ? LIMIT 1', [booking.customerId]);
          booking.customer = customers[0] || null;
        }
        
        if (include.room) {
          // Get room through room_units table
          const roomUnits = await prisma.query('SELECT * FROM room_units WHERE id = ? LIMIT 1', [booking.roomUnitId]);
          if (roomUnits.length > 0) {
            const roomUnit = roomUnits[0];
            const rooms = await prisma.query('SELECT * FROM rooms WHERE id = ? LIMIT 1', [roomUnit.roomId]);
            ...
            if ((include.hotel || include.room?.include?.hotel) && booking.room) {
              const hotels = await prisma.query('SELECT * FROM hotels WHERE id = ? LIMIT 1', [booking.room.hotelId]);
        ...
        if (include.payments) {
          const payments = await prisma.query('SELECT * FROM payments WHERE bookingId = ?', [booking.id]);
    ...
    findMany: async ({ where, orderBy, take, skip, include }) => {
      ...
      const bookings = await prisma.query(sql, params);
      ...
      if (include && bookings.length > 0) {
        ...
        if (include.customer) {
          const customers = await prisma.query('SELECT * FROM customers WHERE id IN (?)', [customerIds]);
        ...
        if (include.room) {
          ...
          if (roomUnitIds.length > 0) {
            const roomUnits = await prisma.query('SELECT * FROM room_units WHERE id IN (?)', [roomUnitIds]);
            const roomIds = [...new Set(roomUnits.map(ru => ru.roomId))];
            
            if (roomIds.length > 0) {
              const rooms = await prisma.query('SELECT * FROM rooms WHERE id IN (?)', [roomIds]);
              ...
              if (include.hotel || include.room?.include?.hotel) {
                ...
                const hotels = await prisma.query('SELECT * FROM hotels WHERE id IN (?)', [hotelIds]);
        ...
        if (include.payments) {
          const payments = await prisma.query('SELECT * FROM payments WHERE bookingId IN (?)', [bookingIds]);
    ...
    update: async ({ where, data }) => {
      ...
      return prisma.booking.findUnique({ where });
    },
    
    delete: async ({ where }) => {
      // Delete related records first (cascade delete)
      await prisma.query('DELETE FROM payments WHERE bookingId = ?', [where.id]);
      
      // Delete the booking
      await prisma.query('DELETE FROM bookings WHERE id = ?', [where.id]);
  ...
  subscriptionPlan: {
    findUnique: async ({ where }) => {
      ...
      if (where.id) {
        const plans = await prisma.query('SELECT * FROM subscription_plans WHERE id = ? LIMIT 1', [where.id]);
        plan = plans[0] || null;
      }
    ...
    findFirst: async ({ where, orderBy }) => {
      ...
      const plans = await prisma.query(sql, params);
      return plans[0] || null;
    },
    ...
    update: async ({ where, data }) => {
      ...
      return prisma.subscriptionPlan.findUnique({ where });
    },
    
    delete: async ({ where }) => {
      await prisma.query('DELETE FROM subscription_plans WHERE id = ?', [where.id]);
      return { id: where.id };
    },
