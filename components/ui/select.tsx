...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-sm",
      "focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/25 focus:ring-offset-0",
...
// Creating a simple compat component for older code
export { Select };

// Export as a simple dropdown select for backward compatibility
export default function SimpleSelect({ 
  ...
  return (
    <Select name={name} value={value} onValueChange={handleChange} {...props}>
