...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2026 at 12:00 PM
...
CREATE TABLE `facility_tasks` (
  ...
  PRIMARY KEY (`taskId`),
  KEY `fk_hotel_1` (`hotelId`),
  KEY `fk_staff_1` (`staffId`),
  KEY `fk_room_unit_1` (`roomUnitId`),
  KEY `fk_vendor_1` (`vendorId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('7f2df696-3595-11f0-9207-db0ca828cf96', 'Maintenance', 'Track facility maintenance tasks', 'ADDON', 5000.00, 1, '2025-05-20 17:17:41', '2025-05-20 17:17:41'),
...
CREATE TABLE `room_units` (
  ...
  PRIMARY KEY (`id`),
  KEY `roomId` (`roomId`),
  KEY `currentBookingId` (`currentBookingId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `subscription_payments` (
  ...
  `updatedAt` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_subscription_payments_vendor` (`vendorId`),
  KEY `idx_subscription_payments_plan` (`subscriptionPlanId`),
  KEY `idx_subscription_payments_date` (`paymentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('1a5c4d20-34ed-11f0-9f7f-5fe7685262f6', 'Vendor User', 'Vendor', 'User', 'vendor@qarashotels.com.ng', '$2b$10$V7GfUL9yyD1WkfH.Ux1mhOmBZMTajSXf6ABQAV.WqCmsbQmAldrS.', 'VENDOR', 1, '2025-05-20 12:00:00', '2026-01-20 14:30:00', '2025-05-20 11:30:00', '2025-05-20 11:30:00'),
...
('e3580441-db39-11f0-9c7c-f0b61e9d0e9e', 'Supervisor Staff', 'Super', 'Visor', 'supervisor@qarashotels.com.ng', '$2b$10$V7GfUL9yyD1WkfH.Ux1mhOmBZMTajSXf6ABQAV.WqCmsbQmAldrS.', 'STAFF', 1, '2025-12-17 08:00:00', '2026-01-26 09:30:00', '2025-12-17 08:15:20', '2026-01-26 09:58:39');
